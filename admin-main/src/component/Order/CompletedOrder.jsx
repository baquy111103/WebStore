                        ...
                        <div className="card">
                            <div className="card-body">
                                ...
                                <div className="table-responsive mt-3" id="customers">
                                        ...
                                        <tbody>
                                            {
                                                order && order.map((value, index) => (
                                                    <tr key={index}>
                                                        ...
                                                        <td className="name">{new Intl.NumberFormat('vi-VN',{style: 'decimal',decimal: '$'}).format(value.total)+ ' $'}</td>
                                    ...
                                    <h4 className="card-title">Total Money: {new Intl.NumberFormat('vi-VN',{style: 'decimal',decimal: '$'}).format(totalMoney)+ ' $'}</h4>
                                </div>
