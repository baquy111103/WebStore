        ...
        <div>
            {
                ...
                <div className="modal_success">
                    <div className="group_model_success pt-3">
                        ...
                        <h4 className="text-center p-3" style={{ color: '#fff' }}>You've added the line successfully!</h4>
                    </div>
                </div>
            }
            {
                ...
                <div className="modal_success">
                    <div className="group_model_success pt-3">
                        ...
                        <h4 className="text-center p-3" style={{ color: '#fff' }}>Please check the login again!</h4>
                    </div>
                </div>
            }
                            ...
                            <div className="product-details-view-content pt-60">
                                <div className="product-info">
                                    ...
                                    <div className="price-box pt-20">
                                        {
                                            sale ? (<del className="new-price new-price-2" style={{ color: '#525252' }}>{new Intl.NumberFormat('vi-VN', { style: 'decimal', decimal: '$' }).format(product.price_product) + ' $'}</del>) :
                                                <span className="new-price new-price-2">{new Intl.NumberFormat('vi-VN', { style: 'decimal', decimal: '$' }).format(product.price_product) + ' $'}</span>
                                        }
                                        <br />
                                        {
                                            sale && (
                                                <span className="new-price new-price-2">{new Intl.NumberFormat('vi-VN', { style: 'decimal', decimal: '$' })
                                                    .format(parseInt(sale.id_product.price_product) - ((parseInt(sale.id_product.price_product) * parseInt(sale.promotion)) / 100)) + ' $'}</span>
                                            )
                                        }
                                    </div>
