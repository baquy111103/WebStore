                            ...
                            <div className="bg_event animate__animated animate__zoomIn col_product">
                                <div>
                                    ...
                                    <div style={{ padding: '1rem 1.2rem' }}>
                                        ...
                                        <div style={{ marginTop: '2rem' }}>
                                            <span style={{ fontSize: '1rem', color: 'gray' }}>Left: <i style={{ color: '#fed700' }}>{value.count} times</i></span>
                                        </div>
                                        <hr />
                                        <div style={{ marginTop: '.5rem' }}>
                                            <span style={{ fontSize: '1rem', color: 'gray' }}>
                                            Opportunity to receive many incentives when buying products at our shop
                                    </span>
                                        </div>
                                        <div style={{ marginTop: '1rem' }} className="d-flex justify-content-center">
                                            <Link to={`/event/${value._id}`} className="a_promotion">Watch Now</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
