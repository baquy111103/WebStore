...
function Checkout(props) {
    ...
    // state load_map
    const [load_map, set_load_map] = useState(false)
    ...
    const [from, set_from] = useState('235 Hoang Quoc Viet, Cau Giay, Ha Noi, Viet Nam')
                                        ...
                                        <table className="table">
                                            ...
                                            <tbody>
                                                {
                                                    carts && carts.map(value => (
                                                        <tr className="cart_item" key={value._id}>
                                                            ...
                                                            <td className="cart-product-total"><span className="amount">{new Intl.NumberFormat('vi-VN',{style: 'decimal',decimal: '$'}).format(parseInt(value.price_product) * parseInt(value.count)) + ' $'}</span></td>
                                                        </tr>
                                                    ))
                                                }
                                            </tbody>
                                            <tfoot>
                                                <tr className="cart-subtotal">
                                                    <th>Shipping Cost</th>
                                                    <td><span className="amount">{new Intl.NumberFormat('vi-VN',{style: 'decimal',decimal: '$'}).format(price) + ' $'}</span></td>
                                                </tr>
                                                <tr className="cart-subtotal">
                                                    <th>Discount</th>
                                                    <td><span className="amount">{new Intl.NumberFormat('vi-VN',{style: 'decimal',decimal: '$'}).format(discount) + ' $'}</span></td>
                                                </tr>
                                                <tr className="order-total">
                                                    <th>Order Total</th>
                                                    <td><strong><span className="amount">{new Intl.NumberFormat('vi-VN',{style: 'decimal',decimal: '$'}).format(total_price) + ' $'}</span></strong></td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    </div>
                                                        ...
                                                        <div className="card-body">
                                                            {
                                                                show_error ? 'Please Checking Information!' :
                                                                <div>
                                                                    <img src="https://cdn.haitrieu.com/wp-content/uploads/2022/10/Logo-MoMo-Square.png" width="50" onClick={handlerMomo}
