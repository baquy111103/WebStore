                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-3 col-md-4">
                            <li><span>Telephone Enquiry:</span><a href="#"> 0345573088</a></li>
                        </div>
                                    ...
                                    <div className="ht-setting-trigger">
                                        {
                                            active_user ? (
                                                ...
                                                <span
                                                    ...
                                                    data-target="#collapseExample"
                                                    aria-expanded="false"
                                                    aria-controls="collapseExample">Sign In</span>
                                            )
                                        }
                                    </div>
                                            ...
                                            search_header && search_header.map(value => (
                                                <div className="hover_box_search d-flex" key={value._id}>
                                                    ...
                                                    <div className="group_title_search" style={{ marginTop: '2.7rem' }}>
                                                        ...
                                                        <span className="price_product_search">{new Intl.NumberFormat('vi-VN', { style: 'decimal', decimal: '$' }).format(value.price_product) + '$'}</span>
                                                    </div>
                                                </div>
                                            ))
                                        }
                                    ...
                                    <li className="hm-wishlist d-flex">
                                        <li className="hm-minicart">
                                            <div className="hm-minicart-trigger"
                                                ...
                                                <span className="item-text">{new Intl.NumberFormat('vi-VN', { style: 'decimal', decimal: '$' }).format(total_price) + ' $'}
                                            ...
                                            <div className="minicart collapse" id="collapse_carts">
                                                        ...
                                                        carts_mini && carts_mini.map((value, index) => (
                                                            <li key={index}>
                                                                ...
                                                                <div className="minicart-product-details">
                                                                    ...
                                                                    <span>{new Intl.NumberFormat('vi-VN', { style: 'decimal', decimal: '$' }).format(value.price_product) + ' $'} x {value.count}, {value.size}</span>
                                                                </div>
                                                ...
                                                <p className="minicart-total">SUBTOTAL: <span>{new Intl.NumberFormat('vi-VN', { style: 'decimal', decimal: '$' }).format(total_price) + ' $'}</span></p>
                                        ...
                                        <ul>
                                            ...
                                            <li className="megamenu-holder"><Link to="/shop/all">Menu</Link>
                                                <ul class="megamenu hb-megamenu">
                                                    <li><Link to="/shop/all">KeyBoard</Link>
                                                        <ul>
                                                            {
                                                    ...
                                                    <li><Link to="/shop">HeadPhone</Link>
                                                        <ul>
                                                            {
