        ...
        <div>
            {
                ...
                <div className="modal_success">
                    <div className="group_model_success pt-3">
                        ...
                        <h4 className="text-center p-3" style={{ color: '#fff' }}>Please check the code again!</h4>
                    </div>
                </div>
            }
            {
                ...
                <div className="modal_success">
                    <div className="group_model_success pt-3">
                        ...
                        <h4 className="text-center p-3" style={{ color: '#fff' }}>Apply the code successfully!</h4>
                    </div>
                </div>
            }
            {
                ...
                <div className="modal_success">
                    <div className="group_model_success pt-3">
                        ...
                        <h4 className="text-center p-3" style={{ color: '#fff' }}>Please check the login status!</h4>
                    </div>
                </div>
            }
            {
                ...
                <div className="modal_success">
                    <div className="group_model_success pt-3">
                        ...
                        <h4 className="text-center p-3" style={{ color: '#fff' }}>Please check the cart again!</h4>
                    </div>
                </div>
            }
                                        ...
                                        <tbody>
                                            {
                                                list_carts && list_carts.map((value, index) => (
                                                    <tr key={index}>
                                                        ...
                                                        <td className="li-product-price"><span className="amount">{new Intl.NumberFormat('vi-VN', { style: 'decimal', decimal: '$' }).format(value.price_product) + ' $'}</span></td>
                                                        ...
                                                        <td className="product-subtotal"><span className="amount">{new Intl.NumberFormat('vi-VN', { style: 'decimal', decimal: '$' }).format(parseInt(value.price_product) * parseInt(value.count)) + ' $'}</span></td>
                                                    </tr>
                                                ))
                                            }
                                        </tbody>
                                ...
                                <div className="row">
                                    <div className="col-md-5 ml-auto">
                                        <div className="cart-page-total">
                                            <h2>Cart totals</h2>
                                            <ul>
                                                <li>Sub Total <span>{new Intl.NumberFormat('vi-VN', { style: 'decimal', decimal: '$' }).format(total_price) + ' $'}</span></li>
                                                <li>Discount <span>{new Intl.NumberFormat('vi-VN', { style: 'decimal', decimal: '$' }).format(discount) + ' $'}</span></li>
                                                <li>Total <span>{new Intl.NumberFormat('vi-VN', { style: 'decimal', decimal: '$' }).format(new_price) + ' $'}</span></li>
                                            </ul>
