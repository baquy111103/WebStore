        ...
        <div>
            <div className="container" style={{ paddingTop: '3rem' }}>
                ...
                <ul>
                    ...
                    <li style={{ fontSize: '1.1rem' }}>Total: <span>{new Intl.NumberFormat('vi-VN',{style: 'decimal',decimal: '$'}).format(order.total) + ' $'}</span></li>
                    <li style={{ fontSize: '1.1rem' }}>Feeship: <span>{new Intl.NumberFormat('vi-VN',{style: 'decimal',decimal: '$'}).format(order.feeship) + ' $'}</span></li>
